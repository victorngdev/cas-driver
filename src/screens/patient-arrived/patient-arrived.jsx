                    ...
                    <View style={styles.infoView}>
                        ...
                        >
                            <View style={{ flex: 4, flexDirection: "column", justifyContent: "center" }}>
                                <Text
                                    style={{ fontFamily: "Texgyreadventor-bold", fontSize: 20, marginLeft: 10 }}
                                    numberOfLines={1}
                                >
                                    Bệnh viện Quân Y
                                </Text>
                                <Text
                                    style={{ fontFamily: "Texgyreadventor-bold", fontSize: 15, marginLeft: 10 }}
                                    numberOfLines={2}
                                >
                        ...
                        >
                            <Text style={{ fontFamily: "Texgyreadventor-bold", marginLeft: 10, fontSize: 18 }}>
                                Ghi chú:
                            </Text>
                    ...
                    <View style={styles.footerView}>
                        ...
                        <View style={{ flex: 4, marginBottom: 10 }}>
                            <TouchableOpacity
                                ...
                                onPress={() => {
                                    Alert.alert("Chuyến đi hoàn thành", "Cảm ơn bạn đã giúp đỡ bệnh nhân");
                                }}
                            >
                                <Text
                                    style={{
