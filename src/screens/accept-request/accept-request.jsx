...
import { StyleSheet, View, ImageBackground, Text, TouchableOpacity, Linking, Modal, Dimensions } from "react-native";
                        ...
                        <View style={styles.footerView}>
                                                    ...
                                                    >
                                                        ...
                                                        <View style={styles.option}>
                                                            ...
                                                            <Text style={{ marginTop: 7 }}>
                                                                Không thể đón bệnh nhân đúng giờ
                                                            </Text>
                                                        </View>
                                                        <View style={styles.option}>
                            ...
                            <View style={{ flex: 2, flexDirection: "row" }}>
                                ...
                                <ButtonText
                                    ...
                                    gotoScreen={() => this.props.navigation.navigate("PatientArrived")}
                                    styleText={{
                                        fontWeight: "bold",
                                        color: "white",
                                        fontSize: 17
