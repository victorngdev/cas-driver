const messages = {
    ...
    102: "Yêu cầu đăng ký xe của bạn đã được chấp nhận.",
    403: "Yêu cầu đăng ký xe của bạn không được phê duyệt.",
    denied: {
        message:
    ...
    100: "Sau khi cập nhật, bạn cần được quản trị viên phê duyệt để có thể nhận được yêu cầu mới. Hãy đảm bảo các thay đổi là cần thiết và chính xác!",
    101: "Các thông tin đã đăng ký sẽ không được truy cập lại sau khi bạn hủy đăng ký. Nếu thông tin bạn đăng ký trước đó không còn giá trị hiệu lực, bạn có thể cập nhật và chờ xét duyệt từ quản trị viên.",
    ...
    206: "Success",
    207: "Hủy yêu cầu thành công!",
    208: "Đăng ký tài khoản thành công!",
    200: "Đón bệnh nhân thành công!",
    209: "Cảm ơn bạn đã giúp đỡ bệnh nhân! Bạn có thể xem lại yêu cầu trong mục lịch sử."
};
